...
#from akad.ttypes import GroupCallMediaType
...
class Call(Config):
    ...
    def acquireGroupCallRoute(self, groupId, mediaType=GroupCallMediaType.AUDIO):
        return self.client.acquireGroupCallRoute(groupId, GroupCallMediaType)
    ...
    def inviteIntoGroupCall(self, chatId, contactIds=[], mediaType=GroupCallMediaType.AUDIO):
        return self.client.inviteIntoGroupCall(chatId, contactIds, GroupCallMediaType)
