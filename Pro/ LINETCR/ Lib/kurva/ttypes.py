...
from src.Thrift import TType, TMessageType, TException, TApplicationException
...
from src.protocol import TBinaryProtocol, TProtocol
try:
  from src.protocol import fastbinary
except:
  fastbinary = None
